...
class CNumberValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if(!is_numeric($value))
		{
			...
			$message=$this->message!==null?$this->message:Yii::t('yii','{attribute} debe ser un Número entero.');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		if(($message=$this->message)===null)
			$message=$this->integerOnly ? Yii::t('yii','{attribute} must be an integer.') : Yii::t('yii','{attribute} debe ser un Número entero.');
